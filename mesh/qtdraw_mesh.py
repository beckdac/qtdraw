...
def qt_mesh(lim, div, feed, seek, probe_depth, travel_height, safe_height, output_filename):
    ...
    with(open(output_filename, 'w') as file):
        ...
        # go to search start
        file.write(f"G0 Z{travel_height} F{seek}\n")
        # probe
        ...
        for x in xv:
            for y in yv:
                ...
                file.write(f"G38.2 Z{probe_depth} F{seek}\n")
                file.write(f"G0 Z2 F{seek}\n")

        file.write(f"G0 Z{safe_height} F{seek}\n")
